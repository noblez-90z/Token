      ...
      {isAuthenticated ? (
        <Layout>
          <div className="capitalize">
            ...
            <div className="block md:flex  justify-center gap-10 py-3 mt-4 px-4">
              ...
              <div className="h-[300px] border-2 border-[#025951] shadow-md rounded-lg px-3 mt-5 md:mt-0">
                <h2 className="font-bold py-2 text-xl">for personal use </h2>
                <p className="font-semibold">
            ...
            <div className="block md:flex  justify-center gap-10 py-3 px-4">
              ...
              <div className="h-[300px]  border-2 border-[#025951] shadow-lg rounded-lg px-3 mt-5 md:mt-0">
                <h2 className="font-bold py-2 text-xl">
                  for organization use{" "}
                </h2>
                <p className="font-semibold">
        ...
        <Layout>
          <div className="flex justify-center items-center h-[400px] bg-[#e5eeee]">
            <div className=" py-6 px-4">
              <h1 className="font-bold text-[24px] italic">hello user</h1>
